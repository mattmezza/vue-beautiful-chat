<template>
  <div style="position: relative">
    ...
    <input type='file' id='file-input' @change="_handleChange" @click="_handleClick" v-if="acceptMemi == 'any'"/>
    <input type='file' id='file-input' @change="_handleChange" @click="_handleClick" v-if="acceptMemi" :accept="acceptMemi"/>
    </button>
  </div>
</template>
